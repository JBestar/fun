...
class BballBet_Model {
    ...
    function getBetSumByMode($arrRoundInfo, $objConfPb){
        ...
        for($i = 0; $i <4; $i ++){
            ...
            $strSql .= " SELECT bet_mb_uid, bet_mode, bet_target, bet_ratio, SUM(bet_money) AS bet_money_sum, mb_game_bb_percent, mb_game_bb2_percent FROM ".$this->mTableName;
