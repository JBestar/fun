...
class BladderBet_Model {
	...
	{
		$this->mDbConn = $dbConn;
		$this->mTableName = "bet_bogleladder";
    ...
    function updateBetRound($objRoundInfo, &$objBetInfo)
    {
     ...
     function getBetSumByMode($arrRoundInfo, $objConfPs){
        ...
        for($i = 0; $i <3; $i ++){
            ...
            $strSql .= " SELECT bet_mb_uid, bet_mode, bet_target, bet_ratio, SUM(bet_money) AS bet_money_sum, mb_game_bs_percent FROM ".$this->mTableName;
